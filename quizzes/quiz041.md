...
class quiz040(MDApp):
    ...
    def update(self):
        ...
        base = self.root.ids.base.text #same as ids['base']
        if base:
            total = int(base)
            for_hash = ""
            net_salary = total
            ...
            self.root.ids.hash.text = hash[-50:] #last 50 charachters
...
## Proof of work
<img width="1470" alt="Screenshot 2025-02-27 at 8 40 42" src="https://github.com/user-attachments/assets/ef5d6d9b-32b5-45f6-a4f8-6a2304e7dba0" />


### For my info
Where is it on PC
>Documents/Coding/CS Lessons/Quizzes/Unit 3/quiz041
